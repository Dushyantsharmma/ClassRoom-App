  ...
  },
{
  ...
  const [profiles, setProfiles] = useState([
...

    {
      ...
      name: 'Ankita Sharma',
      bio: 'Student at Chandigarh University',
      email: 'shubhanksharma70185@gmail.com',
    },
...
const StudyMaterialScreen = ({ onBackToHome }) => {
  const materialData = [
    ...
    {
      title: '100 Days Of DevOps – A Complete Guide For Beginners',
      link: 'https://www.geeksforgeeks.org/100-days-of-devops/',
    },
  ];
